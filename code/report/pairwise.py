...
def build_parser():
    ...
    parser.add_argument("--baseline_result_dir", type=str, default="pwv_3h")
    parser.add_argument("--baseline_label", type=str, default="PWV")
    parser.add_argument("--new_run_root", type=str, required=True)
    parser.add_argument("--new_result_dir", type=str, default="pwv_3h")
    parser.add_argument("--new_label", type=str, default="PWV")
