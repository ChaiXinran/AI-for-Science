...
python -u train_pwv_coupled_v2.py \
    ...
    --save_dir ../checkpoints/quick_3h_pwv_v2_focus \
    --readme_ckpt ../checkpoints/quick_3h_pwv_v2_focus.ckpt \
    --device cuda:0 \
    --input_length 9 \
    --total_length 39 \
    --img_height 96 \
    ...
    --radar_checkpoint ../checkpoints/quick_3h_radar.ckpt \
    --freeze_radar_epochs 1 \
    --lambda_coupling_smooth 0.02 \
    --lambda_coupling_l1 0.0001 \
    --lambda_align 0.08 \
    --lambda_shuffle 0.05 \
    --lambda_growth 0.12 \
    --lambda_extreme 0.06 \
