...
cp code/protocols/pwv_causal_preconditioning_probe.json "${PROBE_ROOT}/protocol/"
...
python -u code/diagnostics/pwv_preconditioning_probe.py \
  ...
  --pwv_history_minutes 180 --pwv_anchor_minutes 30 \
